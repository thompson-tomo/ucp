...
**→ [Payment Handler Template](https://ucp.dev/specification/payment-handler-template/index.md)**
...
| **Link to examples**            | Reference existing handler specs and the [Tokenization Guide](https://ucp.dev/specification/tokenization-guide/index.md) for common flows. |
