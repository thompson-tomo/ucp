...
| Name                   | Type                                                                        | Required | Description                                                |
| ---------------------- | --------------------------------------------------------------------------- | -------- | ---------------------------------------------------------- |
| merchant_authorization | [Merchant Authorization](https://ucp.dev/draft/specification/reference/%7B) | No       | Merchant's signature proving checkout terms are authentic. |

#### Ap2 With Checkout Mandate

| Name             | Type                                                                  | Required | Description                                      |
| ---------------- | --------------------------------------------------------------------- | -------- | ------------------------------------------------ |
| checkout_mandate | [Checkout Mandate](https://ucp.dev/draft/specification/reference/%7B) | No       | SD-JWT+kb proving user authorized this checkout. |
...
| email        | string                                                       | No       | Email of the buyer.      |
| phone_number | string                                                       | No       | E.164 standard.          |
| consent      | [Consent](https://ucp.dev/draft/specification/reference/%7B) | No       | Consent tracking fields. |
...
| payment      | object                                                     | No       | Payment configuration containing handlers.                                                                                                                                                                                                                      |
| order        | object                                                     | No       | Details about an order created for this checkout session.                                                                                                                                                                                                       |
| buyer        | [Buyer](https://ucp.dev/draft/specification/reference/%7B) | No       | Buyer with consent tracking.                                                                                                                                                                                                                                    |
...
| allocations | Array\[[Allocation](https://ucp.dev/draft/specification/reference/%7B)\] | No       | Breakdown of where this discount was allocated. Sum of allocation amounts equals total amount.                                   |
...
| applied | Array\[[Applied Discount](https://ucp.dev/draft/specification/reference/%7B)\] | No       | Discounts successfully applied (code-based and automatic).                                                 |
...
| payment      | object                                                                | No       | Payment configuration containing handlers.                                                                                                                                                                                                                      |
| order        | object                                                                | No       | Details about an order created for this checkout session.                                                                                                                                                                                                       |
| discounts    | [Discounts Object](https://ucp.dev/draft/specification/reference/%7B) | No       |                                                                                                                                                                                                                                                                 |
...
| payment      | object                                                           | No       | Payment configuration containing handlers.                                                                                                                                                                                                                      |
| order        | object                                                           | No       | Details about an order created for this checkout session.                                                                                                                                                                                                       |
| fulfillment  | [Fulfillment](https://ucp.dev/draft/specification/reference/%7B) | No       | Fulfillment details.                                                                                                                                                                                                                                            |
