...
| description      | [Description](https://ucp.dev/draft/specification/catalog/%7B)             | **Yes**  | Product description in one or more formats.                                                      |
| url              | string                                                                     | No       | Canonical product page URL.                                                                      |
| categories       | Array\[[Category](https://ucp.dev/draft/specification/catalog/%7B)\]       | No       | Product categories with optional taxonomy identifiers.                                           |
| price_range      | [Price Range](https://ucp.dev/draft/specification/catalog/%7B)             | **Yes**  | Price range across all variants.                                                                 |
| list_price_range | [Price Range](https://ucp.dev/draft/specification/catalog/%7B)             | No       | List price range before discounts (for strikethrough display).                                   |
| media            | Array\[[Media](https://ucp.dev/draft/specification/catalog/%7B)\]          | No       | Product media (images, videos, 3D models). First item is the featured media for listings.        |
| options          | Array\[[Product Option](https://ucp.dev/draft/specification/catalog/%7B)\] | No       | Product options (Size, Color, etc.).                                                             |
| variants         | Array\[[Variant](https://ucp.dev/draft/specification/catalog/%7B)\]        | **Yes**  | Purchasable variants of this product. First item is the featured variant for listings.           |
| rating           | [Rating](https://ucp.dev/draft/specification/catalog/%7B)                  | No       | Aggregate product rating.                                                                        |
...
| description      | [Description](https://ucp.dev/draft/specification/catalog/%7B)              | **Yes**  | Variant description in one or more formats.                                               |
| url              | string                                                                      | No       | Canonical variant page URL.                                                               |
| categories       | Array\[[Category](https://ucp.dev/draft/specification/catalog/%7B)\]        | No       | Variant categories with optional taxonomy identifiers.                                    |
| price            | [Price](https://ucp.dev/draft/specification/catalog/%7B)                    | **Yes**  | Current selling price.                                                                    |
| list_price       | [Price](https://ucp.dev/draft/specification/catalog/%7B)                    | No       | List price before discounts (for strikethrough display).                                  |
...
| selected_options | Array\[[Selected Option](https://ucp.dev/draft/specification/catalog/%7B)\] | No       | Option selections that define this variant.                                               |
| media            | Array\[[Media](https://ucp.dev/draft/specification/catalog/%7B)\]           | No       | Variant media (images, videos, 3D models). First item is the featured media for listings. |
| rating           | [Rating](https://ucp.dev/draft/specification/catalog/%7B)                   | No       | Variant rating.                                                                           |
...
| Name     | Type                                                      | Required | Description                                           |
| -------- | --------------------------------------------------------- | -------- | ----------------------------------------------------- |
| amount   | [Amount](https://ucp.dev/draft/specification/catalog/%7B) | **Yes**  | Amount in ISO 4217 minor units. Use 0 for free items. |
...
| Name | Type                                                     | Required | Description                 |
| ---- | -------------------------------------------------------- | -------- | --------------------------- |
| min  | [Price](https://ucp.dev/draft/specification/catalog/%7B) | **Yes**  | Minimum price in the range. |
| max  | [Price](https://ucp.dev/draft/specification/catalog/%7B) | **Yes**  | Maximum price in the range. |
...
| values | Array\[[Option Value](https://ucp.dev/draft/specification/catalog/%7B)\] | **Yes**  | Available values for this option.    |
...
| code         | [Error Code](https://ucp.dev/draft/specification/catalog/%7B) | **Yes**  | Error code identifying the type of error. Standard errors are defined in specification (see examples), and have standardized semantics; freeform codes are permitted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
